  ...
  return (
    <div className="flex justify-between items-center shadow-lg p-4 bg-gradient-to-r from-blue-500 to-indigo-500 text-white mx-auto">
      ...
      <div className="flex items-center">
        <Link to="/sign_in_up">
          <button className="px-6 py-2 bg-white text-blue-600 font-semibold rounded-full shadow-md hover:bg-blue-100 transform transition duration-200 ease-in-out">
            Sign In
          </button>
        </Link>
      </div>
